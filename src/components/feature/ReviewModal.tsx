// components/feature/ReviewModal.tsx
'use client';
...
export default function ReviewModal({ isOpen, onClose, handymanName, handymanId, onSubmit }: ReviewModalProps) {
  ...
  // Reset form when modal opens/closes - MOVED BEFORE ANY CONDITIONAL RETURN
  useEffect(() => {
    if (!isOpen) {
      setRating(0);
      setHoveredRating(0);
  ...
  // DON'T return early before hooks - move all hooks above
          ...
          <div className="border-b border-gray-200 flex-none py-4 px-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-900">
                Write a Review for {handymanName}
              </h2>
              <button
                onClick={onClose}
          ...
          <div className="w-full overflow-y-auto flex-1 py-6 px-6">
            ...
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600">
                <img 
                  src="https://ui-avatars.com/api/?background=3B82F6&color=fff&bold=true&size=48"
                  alt="Your avatar"
            ...
            <div className="mb-6">
              ...
              <button
                ...
                className="w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 hover:bg-blue-50 transition-colors group"
              >
              ...
              <p className="text-xs text-gray-500 mt-2">
                You can upload up to 5 photos (JPEG, PNG)
              </p>
            </div>
          </div>
