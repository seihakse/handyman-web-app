    ...
    <aside className="w-64 bg-[#2563eb] text-white flex flex-col flex-shrink-0">
      <div className="p-6">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-[#bfdbfe] text-primary-800 rounded-lg flex items-center justify-center font-bold text-xl">
            H
          </div>
          <div>
          ...
          {menuItems.map((item, index) => (
            ...
            <a
                ...
                item.active
                    ...
                    : 'text-primary-200 hover:text-white hover:bg-transparent'
                }`}
            >
